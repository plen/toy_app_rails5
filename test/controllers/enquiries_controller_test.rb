...
class EnquiriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post enquiries_url, params: { enquiry: { enquiry_date: @enquiry.enquiry_date, max_cost: @enquiry.max_cost, min_cost: @enquiry.min_cost, pax: @enquiry.pax, user_id: @enquiry.user_id } }
    end
  ...
  test "should update enquiry" do
    patch enquiry_url(@enquiry), params: { enquiry: { enquiry_date: @enquiry.enquiry_date, max_cost: @enquiry.max_cost, min_cost: @enquiry.min_cost, pax: @enquiry.pax, user_id: @enquiry.user_id } }
